...
app.patch("/jokes/:id", (req, res) => {
  ...
  const replacementJoke = {
    id : id,
    jokeText : req.body.text || existingJoke.text,  //It works like if-else statement
...
app.delete("/all", (req, res) => {
  ...
  if (userKey === masterKey) {    //Here we need to give the authentication to delete all the jokes.
    jokes = [];
    res.sendStatus(200);
  } else {
    res
